...
const DotField = memo(({
  ...
  useEffect(() => {
    ...
    function tick() {
      ...
      grad.addColorStop(0, p.gradientFrom || 'transparent');
      grad.addColorStop(1, p.gradientTo || 'transparent');
      ctx!.fillStyle = grad;
      ...
      for (let i = 0; i < len; i++) {
        ...
        if (distSq < crSq && eng > 0.01) {
          ...
          if (isBulge) {
            const tParam = 1 - dist / cr;
            const push = tParam * tParam * (p.bulgeStrength || 67) * eng;
